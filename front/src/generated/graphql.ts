...
export type CreatePlayerMutation = {
    __typename?: 'Mutation'
    createManyPlayer: { __typename?: 'AffectedRowsOutput'; count: number }
}
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        Players(variables?: PlayersQueryVariables, requestHeaders?: Dom.RequestInit['headers']): Promise<PlayersQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<PlayersQuery>(PlayersDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                'Players',
        ...
        CreatePlayer(
            ...
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<CreatePlayerMutation>(CreatePlayerDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                'CreatePlayer',
        ...
        getSchoolById(
            ...
            requestHeaders?: Dom.RequestInit['headers'],
        ): Promise<GetSchoolByIdQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetSchoolByIdQuery>(GetSchoolByIdDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                'getSchoolById',
